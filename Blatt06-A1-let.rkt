...
#reader(lib "DMdA-beginner-reader.ss" "deinprogramm")((modname Blatt06-A1-let) (read-case-sensitive #f) (teachpacks ()) (deinprogramm-settings #(#f write repeating-decimal #f #t none explicit #f ())))
; Aufgabe 1
